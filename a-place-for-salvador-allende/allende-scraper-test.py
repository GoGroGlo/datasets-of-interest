...
index = 'http://www.abacq.org/calle/index.php?'
...
# test these links
single_locale = [
    'http://www.abacq.org/calle/index.php?2013/09/11/587-berlin-alemania',
    'http://www.abacq.org/calle/index.php?2012/07/19/575-berlin-alemania',
    'http://www.abacq.org/calle/index.php?2011/06/27/527-san-joaquin-chile'
]
...
for (i, link) in enumerate(single_locale, start=1):
    ...
    #
    article_soup = BeautifulSoup(driver.page_source, 'html.parser', parse_only=SoupStrainer("div", class_="post"), exclude_encodings='Unicode')
    ...
    try:
        ...
        name = 'A homage to Salvador Allende'
    else:
...
# test these links
multi_locale = [
    'http://www.abacq.org/calle/index.php?2007/02/18/25-ecuador',
